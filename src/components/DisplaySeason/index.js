  ...
  render() {
        ...
        if ( (this.props.store.app.seasonStatus) && (this.props.store.app.getChartData) ) {
            ...
            const afterRender = (chart) => {
                chart.renderer.text(year + ' Season Outlook', 300, 85).css({ color:"#000000", fontSize:"16px"}).add();
            };
            ...
            var chartConfig = {
                 ...
                 series: [{
                     ...
                     name: "POR Max", data: gdd_max, type: "line", showInLegend: false, zIndex: 1, lineWidth: 2, color: "#444444", marker: { enabled: false, states: { hover: { enabled: false }} } },{
