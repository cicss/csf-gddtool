...
//@scriptLoader(
//  ['http://tools.climatesmartfarming.org/tstctool/js/location-dialog-min.js',
//   URL_google_api,
//   'http://tools.climatesmartfarming.org/tstctool/js/basil.min.js',
//   'http://tools.climatesmartfarming.org/tstctool/js/manage-local-storage.js'
//  ],
//)
@scriptLoader(
  ['http://tools.climatesmartfarming.org/gddtool_react/js/location-dialog-min.js',
   URL_google_api,
   'http://tools.climatesmartfarming.org/gddtool_react/js/basil.min.js',
   'http://tools.climatesmartfarming.org/gddtool_react/js/manage-local-storage.js'
  ],
)
